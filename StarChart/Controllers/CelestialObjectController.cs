...
namespace StarChart.Controllers
{
    ...
    public class CelestialObjectController : ControllerBase
    {
        ...
        {
            var excistingObject = _context.CelestialObjects.Find(id);
            if (excistingObject == null) return NotFound();
            excistingObject.Name = name;
            _context.CelestialObjects.Update(excistingObject);
            _context.SaveChanges();
            return NoContent();
        }
